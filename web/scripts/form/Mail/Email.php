	...
	class rvEmail
	{
		function onlineFormMail($message, $FormMail, $subject, $toMail, $ob)
		{
            ...
            if (class_exists('SGL_Emailer')) {
                ...
                $mail = &rvEmail::_factory();
            }
            $crlf = (class_exists('SGL_String')) ? SGL_String::getCrlf() : rvEmail::getCrlf();
